...
public class Framework {
	...
	public static final String ACCEPTEDTERMS_PATH = DATA_PATH + "AcceptedTerms/";
	public static final String ACCEPTEDHIERARCHIES_PATH = DATA_PATH + "AcceptedHierarchies/";
